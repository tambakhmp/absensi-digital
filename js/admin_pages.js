...
async function clearLogAktivitasAdmin() {
  const jumlah = parseInt(prompt('Berapa baris log yang akan dihapus?
Ketik jumlah atau kosongkan untuk hapus SEMUA.
(Ketik HAPUS untuk konfirmasi)') || '');
  const konfirm = prompt('Ketik HAPUS untuk mengosongkan log aktivitas:');
