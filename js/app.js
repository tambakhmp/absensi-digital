  ...
  return `
    <div style="max-width:540px;margin:0 auto">
      <div class="card" style="padding:24px;text-align:center">
        ...
        <h2 style="font-size:20px;font-weight:800;margin:0 0 8px">Absen Karyawan via QR</h2>
        <p style="font-size:13px;color:#64748B;margin:0 0 20px;line-height:1.6">
          Fitur <strong>cadangan</strong> untuk karyawan yang HP-nya bermasalah dengan GPS.
          Admin scan QR karyawan di HP karyawan, lalu ambil foto wajah karyawan.
        </p>

        <div style="background:#FEF3C7;border-left:3px solid #F59E0B;border-radius:8px;
          padding:12px 14px;margin-bottom:20px;font-size:12px;color:#78350F;text-align:left;line-height:1.6">
          ⚠️ <strong>Syarat pakai:</strong>
          <ul style="margin:6px 0 0 20px;padding:0">
            <li>Karyawan buka dashboard di HP-nya (QR akan muncul otomatis)</li>
            <li>GPS admin harus aktif & dalam radius kantor</li>
            <li>Izinkan akses kamera saat diminta</li>
          </ul>
        </div>

        <button class="btn btn--primary btn--full" onclick="bukaAbsenQR()"
          style="font-size:16px;padding:14px">
          📷 Mulai Scan QR
        </button>

        <p style="font-size:11px;color:#94A3B8;margin:14px 0 0">
          Setiap absen via QR akan tercatat dengan keterangan
          <code>Via QR oleh [nama admin]</code> dan email notif ke karyawan.
        </p>
      </div>
    </div>`;
}
