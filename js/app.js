...
function renderPageDashboard(c) {
  ...
  c.innerHTML = `<div class="page-content">
    ...
    <!-- 📋 SURAT TUGAS PENDING — perlu tanda tangan -->
    <div id="surat-tugas-pending-section"></div>

    <!-- 📝 SURAT IZIN PENDING — perlu tanda tangan -->
    <div id="surat-izin-pending-section"></div>
    ...
    <div class="admin-layout">
      <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar__nav" id="sidebar-nav">
          ...
          ${_si2('arsip-admin','🗂️','Arsip Dokumen')}
...
function routeAdmin(page) {
  ...
  const pages={
    ...
    'arsip-admin':       ['Arsip Dokumen',    ()=>loadArsipDokumen()],
...
async function loadJadwalMingguSaya() {
  try {
    let data = await callAPI('getJadwalSaya', {});
