...
async function _exportFotoPDF() {
  ...
  try {
    ...
    let instansi = {};
    try {
      const sett = await callAPI('getAllSettings', {});
      instansi = {
        nama_instansi  : sett.nama_instansi  || sett.nama_perusahaan || '',
        alamat_instansi: sett.alamat_instansi || sett.alamat         || '',
        telp_instansi  : sett.telp_instansi  || sett.telp            || '',
        email_instansi : sett.email_instansi  || sett.email          || '',
        logo_url       : sett.logo_url        || ''
      };
