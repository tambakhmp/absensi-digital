    ...
    <div style="max-width:640px;margin:0 auto">
      <div class="card" style="padding:24px">
        <div style="text-align:center;margin-bottom:20px">
          ...
          <h2 style="font-size:20px;font-weight:800;margin:0 0 6px">Absensi via QR ID Card</h2>
          <p style="font-size:13px;color:#64748B;margin:0;line-height:1.6">
            Fitur <strong>cadangan</strong> menggunakan QR permanen di ID card karyawan.
          </p>
        </div>
        ...
        <div style="background:#FEF3C7;border-left:3px solid #F59E0B;border-radius:8px;
          ...
          <ul style="margin:6px 0 0 20px;padding:0">
            <li>Hanya <strong>admin</strong> yang bisa scan QR (karyawan tidak bisa)</li>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:14px">
          <button onclick="bukaAbsenQR()"
            style="background:#10B981;color:#fff;border:none;border-radius:12px;padding:20px 14px;
            cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:8px;
            box-shadow:0 2px 8px rgba(16,185,129,.2)">
            <span style="font-size:32px">📷</span>
            <span style="font-size:14px;font-weight:700">Scan QR Absen</span>
            <span style="font-size:11px;opacity:.9">Untuk absen datang/pulang</span>
          </button>

          <button onclick="bukaGeneratorQR()"
            style="background:#2D6CDF;color:#fff;border:none;border-radius:12px;padding:20px 14px;
            cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:8px;
            box-shadow:0 2px 8px rgba(45,108,223,.2)">
            <span style="font-size:32px">🖨️</span>
            <span style="font-size:14px;font-weight:700">Cetak QR ID Card</span>
            <span style="font-size:11px;opacity:.9">Generate QR untuk print</span>
          </button>
        </div>

        <div style="background:#EFF6FF;border-radius:8px;padding:10px 14px;font-size:11.5px;color:#1E3A8A;line-height:1.5">
          💡 <strong>Alur kerja:</strong> Karyawan baru → <strong>Cetak QR ID Card</strong> → tempel/print di ID card.
          Saat karyawan lupa/tidak bawa HP → admin <strong>Scan QR Absen</strong> di ID card-nya.
        </div>
      </div>
    </div>`;
}
