...
// Menggunakan: jsPDF (CDN) + SheetJS (CDN)
// ============================================================

// ─────────────────────────────────────────────────────────────
// REKAP ABSENSI KARYAWAN — PDF
// ─────────────────────────────────────────────────────────────
async function cetakRekapPDF(idKaryawan, bulan, tahun) {
  showToast('Mempersiapkan dokumen PDF...', 'info', 2000);

  try {
    const data = await callAPI('getRekapLengkap', { id_karyawan: idKaryawan, bulan, tahun });
