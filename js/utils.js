...
// ─── Drive URL normalization (dibutuhkan branding.js dan admin_pages.js) ───
...
// ─── Kunci/buka tombol absen (dibutuhkan dashboard.js dan absensi.js) ───────
function _kunciTombolAbsen(masukSudah, keluarSudah) {
  ...
  if (btnK) {
    const locked = keluarSudah || !masukSudah;
    btnK.disabled = locked;
    btnK.classList.remove('loading');
    btnK.style.opacity = locked ? '0.45' : '1';
    btnK.style.cursor  = locked ? 'not-allowed' : 'pointer';
